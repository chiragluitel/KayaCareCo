...
export const HeroImageWithTextAndCTA = () => {
  return (
    <section className="relative w-full min-h-[600px] flex items-center bg-brand-primary">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="max-w-2xl text-white space-y-6">
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            ...
            <CTA variant="outline" className="bg-white/10 text-white border-white hover:bg-white/20" to="/services">
              View Our Services
            </CTA>
          </div>
        </div>
